...
export type LoyalOracle = {
  ...
  instructions: [
    {
      name: "createChat";
      discriminator: [133, 186, 254, 72, 143, 178, 221, 28];
      accounts: [
        {
          name: "payer";
          writable: true;
        ...
        {
          name: "chat";
          docs: ["creates the interaction PDA if needed"];
          writable: true;
          pda: {
            seeds: [
              {
    ...
    {
      name: "createContext";
      discriminator: [87, 62, 197, 44, 169, 57, 243, 178];
      accounts: [
        {
          name: "payer";
          writable: true;
        ...
        },
        {
          ...
          pda: {
            seeds: [
              {
                kind: "const";
                value: [99, 111, 110, 116, 101, 120, 116];
              },
              {
                kind: "account";
                path: "payer";
    ...
    {
      name: "delegateChat";
      discriminator: [50, 211, 191, 65, 208, 161, 231, 189];
      accounts: [
        {
          name: "payer";
          writable: true;
    ...
    {
      name: "getDek";
      discriminator: [236, 216, 253, 103, 17, 232, 143, 109];
      accounts: [
        {
          name: "caller";
          docs: ["chat.user OR the oracle identity."];
          writable: true;
          signer: true;
        },
        {
          name: "chat";
          docs: ["Must be owned by this program."];
          writable: true;
        }
      ];
      args: [];
  ...
  accounts: [
    ...
    {
      name: "contextAccount";
      discriminator: [75, 176, 185, 173, 144, 35, 90, 109];
    },
    {
      name: "identity";
  ...
  events: [
    {
      name: "dekResponse";
      discriminator: [114, 0, 186, 146, 6, 67, 29, 225];
    },
    {
      name: "statusChanged";
      discriminator: [146, 235, 222, 125, 145, 246, 34, 240];
    }
  ];
  errors: [
    {
  ...
  types: [
    {
      ...
      type: {
        ...
        fields: [
          {
            name: "context";
            docs: ["---- fixed-size header (stable offsets) ----"];
            type: "pubkey";
          },
          {
            name: "user";
